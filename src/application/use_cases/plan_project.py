        ...
        for i, line in enumerate(lines):
            ...
            if line and line[0].isdigit():
                ...
                if len(parts) > 1:
                    ...
                    if i > 0 and any(word in title.lower() for word in ['database', 'crud', 'frontend', 'authentication']):
                        # Find setup task
                        for prev_task in tasks:
                            if 'set up' in prev_task.title.lower() or 'setup' in prev_task.title.lower():
