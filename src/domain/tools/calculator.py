...
class CalculatorTool(Tool):
    ...
    async def calculate(self, expression: str) -> ToolResult:
        ...
        try:
            ...
            if not expression:
                return ToolResult(success=False, data={}, error="Empty expression provided")
            ...
            try:
                ...
                return ToolResult(
                    success=False, data={}, error=f"Syntax error in expression: {str(e)}"
                )
            ...
            try:
                ...
                return ToolResult(success=False, data={}, error="Division by zero error")
            ...
            try:
                ...
                return ToolResult(
                    success=False, data={}, error=f"Result cannot be converted to number: {result}"
                )
